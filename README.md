...
-  Extraer el .zip del proyecto.
-  Crear un archivo llamado .env (porque no lo trae github), usar la estructura de .env.example como ejemplo y cambiar estos parametros.
