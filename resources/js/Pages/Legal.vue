  ...
  <Master>
    <div id="terminos">
      ...
      <div class="roundframe">
        <div>
          Datos identificativos del titular de la web<br /><br />En cumplimiento
          ...
          referida norma:<br /><br />Denominación social: ALANDAL<br /><br />Dirección
          de correo electrónico: contacto@alandal.com<br /><br />La presente
          ...
          se comprometen a respetar.<br /><br />El responsable del tratamiento
          ...
          del tratamiento:<br /><br />En tanto en cuanto contamos con el
          ...
          como base jurídica.<br /><br />Si el tratamiento de los datos
          ...
          1) del artículo 6 del RGPD.<br /><br />Si el tratamiento de los datos
          personales es consecuencia de una obligación legal por nuestra parte,
          nos remitimos al apartado c) del punto 1) del artículo 6 del RGPD.<br /><br />Si
          ...
          basamos en el apartado d) del punto 1) del artículo 6 del RGPD.<br /><br />Si
          ...
          nos remitimos al apartado e) del punto 1) del artículo 6 del RGPD.<br /><br />Mientras
          ...
          punto 1) del artículo 6 del RGPD.<br /><br />Definiciones<br /><br />
          “Página”, dominio www.ALANDAL.com que se pone a disposición de los
          Usuarios de Internet.<br /><br />“Usuario”, persona física o jurídica
          que utiliza o navega por la Página.<br /><br />“Contenido”, son las
          ...
          cualquier clase de material contenido en la Página.<br /><br />“Web”,
          ...
          que el titular pone a disposición de los Usuarios de Internet.<br /><br />“Hiperenlace”,
          ...
          botón o indicativo que contiene el enlace.<br /><br />“Cookies”, medio
      ...
      <div class="p-3 mb-2 bg-primary text-white">
        <h3 class="catbg">Condiciones de uso</h3>
      </div>
      <span class="upperframe"><span></span></span>
      <div class="roundframe">
        <div>
          ...
          utilizar la Página.<br /><br />A través de la Página, ALANDAL facilita
          ...
          autorizados.<br /><br />El Usuario está obligado y se compromete a
          ...
          costumbres generalmente aceptadas.<br /><br />A tal efecto, el Usuario
          ...
          Internet (hardware y software)<br /><br />¿Qué datos vamos a obtener
          de ti?<br /><br />El Usuario se obliga y se compromete a no
          ...
          carácter limitativo.<br /><br />Asimismo, de conformidad con todo
          ello, el Usuario no podrá:<br /><br />Trataremos tus datos
          personales<br /><br />- Reproducir, copiar, distribuir, poner a
          ...
          permitido.<br /><br />- Suprimir, manipular o de cualquier forma
          ...
          establecidos para su reconocimiento.<br /><br />El Usuario deberá
      ...
      <div class="roundframe">
        <div>
          ...
          o puedan existir sobre dichos Contenidos.<br /><br />De igual modo los
          ...
          reproducción, distribución, comunicación pública y transformación.<br /><br />La
          ...
          establecidas.<br /><br />Hiperenlaces<br /><br />¿Qué Aquellas
          personas que se propongan establecer hiperenlaces entre su página Web
          y la Página deberán observar y cumplir las condiciones siguientes:<br /><br />-
          ...
          autorización expresa e inequívoca por escrito por parte de ALANDAL.<br /><br />-
          No se crearán “marcos” (“frames”) con las páginas Web ni sobre las
          páginas Web de ALANDAL.<br /><br />- No se realizarán manifestaciones
          ...
          Página, o de los Contenidos suministrados.<br /><br />- No se
          ...
          que se establece el Hiperenlace.<br /><br />- La página Web en la que
          se establezca el Hiperenlace solo podrá contener lo estrictamente
          necesario para identificar el destino del Hiperenlace.<br /><br />La
      ...
      <span class="lowerframe"><span></span></span>
      <div class="p-3 mb-2 bg-primary text-white">
        <h3 class="catbg">Disponibilidad de la Página</h3>
      </div>
      <span class="upperframe"><span></span></span>
      <div class="roundframe">
        <div>
          ...
          la prestación del mismo o con carácter previo.<br /><br />ALANDAL
          ...
          usuarios hubieren podido atribuir a la Página y a los Contenidos.<br /><br />La
          ...
          constituyen sugerencia ni recomendación alguna.<br /><br />ALANDAL
          ...
          causados al usuario por este motivo.<br /><br />El acceso a la Página
          ...
          de versiones no actualizadas del mismo.<br /><br />Calidad de la
          Página<br /><br />Dado el entorno dinámico y cambiante de la
          ...
          Contenidos.<br /><br />La información contenida en las páginas que
          ...
          de compromiso vinculante o contractual.<br /><br />Limitación de
          responsabilidad<br /><br />ALANDAL excluye toda responsabilidad
          ...
          Contenidos.<br /><br />Notificaciones<br /><br />Todas las
          ...
          efectos.<br /><br />Disponibilidad de los Contenidos<br /><br />La
          ...
          advertirá previamente la terminación o suspensión de la Página.<br /><br />Protección
          de Datos de Carácter Personal<br /><br />ALANDAL es consciente de
          ...
          en las líneas de actuación de la entidad.<br /><br />Por favor, le
      ...
      <div class="roundframe">
        <div>
          ...
          corresponderles.<br /><br />Legislación aplicable<br /><br />El Aviso
          Legal se rige por la ley española.<br /><br />Copyright © 2020 –
          ALANDAL<br /><br />Reservados todos los derechos de autor por las
